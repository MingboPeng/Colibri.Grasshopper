...
namespace Colibri.Grasshopper
{
    static class IteratorParam
    {
        ...
        /// </summary>
        public static Dictionary<InputType, IGH_Param> CheckAndGetConnectedInputSource(IGH_Param SelInputSource)
        {
            ...
            { 
                ...
                component.NickName = String.IsNullOrEmpty(component.NickName) ? "RenamePlease" : component.NickName; //Check if nick name exists
        ...
        public static void changeParamNickName(Dictionary<InputType, IGH_Param> ValidSourceParam, IGH_Param InputParam, IGH_Param OutputParam)
        {
            ...
            inputParam.NickName = type == InputType.Unsupported ? type.ToString(): type.ToString()+"_"+inputSource.NickName;
            outputParam.NickName = type == InputType.Unsupported? inputParam.NickName : inputSource.NickName;
            outputParam.Description = "This item is one of values from " + inputParam.NickName;
